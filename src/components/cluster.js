...
var getExtendedBounds = function (map, bounds, gridSize) {
  ...
  return new window.BMap.Bounds(newSW, newNE)
}
/**
...
var cutBoundsInRange = function (bounds) {
  ...
  return new window.BMap.Bounds(new window.BMap.Point(minX, minY), new window.BMap.Point(maxX, maxY))
}
...
MarkerClusterer.prototype._addToClosestCluster = function (marker) {
  ...
  if (clusterToAddTo && clusterToAddTo.isMarkerInClusterBounds(marker)) {
    ...
    var clusterNew = new Cluster(this)
    clusterNew.addMarker(marker)
    this._clusters.push(clusterNew)
  }
}
...
function Cluster (markerClusterer) {
  ...
  let that = this
  this._clusterMarker.addEventListener('mouseover', function (e) {
    let value = {
      lat: e.currentTarget._position.lat,
      lng: e.currentTarget._position.lng,
      markers: that._markers.map(m => { return { lat: m.point.lat, lng: m.point.lng } })
    }
    let cmd = {
      type: 'baludCluster',
      value: value,
...
Cluster.prototype.remove = function () {
  ...
  this._clusterMarker.removeEventListener('mouseover')
  this._clusterMarker.removeEventListener('mouseout')
